...
namespace Google.Helpers.Elevation
{
	/// <summary>
	...
	public class ElevationRequest
	{
		...
		public IList<LatitudeLongitude> Locations 
		{
			get 
			{
				if (_locations == null) _locations = new List<LatitudeLongitude>();
				return _locations;
			}
		}
		...
		public void AddLocations(params LatitudeLongitude[] locationCollection)
		{
			...
			IList<LatitudeLongitude> myLocations = this.Locations;
		...
		public IList<LatitudeLongitude> Path
		{
			get
			{
				if (this._path == null) this._path = new List<LatitudeLongitude>();
				return this._path;
			}
		}
