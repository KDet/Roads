...
namespace Google.Helpers
{
	public class PolylineEncoder
	{
		...
		public static IEnumerable<LatitudeLongitude> Decode(string value)
		{
			...
			if (value == null || value == "") return new List<LatitudeLongitude>(0);
			...
			List<LatitudeLongitude> poly = new List<LatitudeLongitude>();
			...
			while (index < polylinechars.Length)
			{
				...
				LatitudeLongitude point = new LatitudeLongitude(
