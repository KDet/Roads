...
namespace Google.Helpers.DistanceMatrix
{
	...
	public class DistanceMatrixRequest
	{
		...
		/// </summary>
		private SortedDictionary<int, Waypoint> waypointsOrigin;

		/// <summary>
		/// List of destination waypoints
		/// </summary>
        private SortedDictionary<int, Waypoint> waypointsDestination;
        ...
        public SortedDictionary<int, Waypoint> WaypointsOrigin
		{
			get
			{
				...
				{
                    waypointsOrigin = new SortedDictionary<int, Waypoint>();
				}
        ...
        public SortedDictionary<int, Waypoint> WaypointsDestination
		{
			get
			{
				...
				{
                    waypointsDestination = new SortedDictionary<int, Waypoint>();
				}
