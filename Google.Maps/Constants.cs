...
namespace Google.Maps
{
	internal static class Constants
	{
		...
		public static bool IsExpectedNamedColor(string value)
		{
			...
			return (Contains(S_ExpectedNamedColors, value, StringComparison.OrdinalIgnoreCase));
		}
		...
		private static bool Contains(string[] array, string value, StringComparison ignoreCase)
		{
