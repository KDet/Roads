...
namespace LvivRoads.Core.Services
{
	...
	public class MapMarkers
	{
        ...
        public MapMarkers(params Position[] locations)
		{
            Locations = new List<Position>(locations);
		}
		...
		/// </summary>
        public ICollection<Position> Locations { get; set; }
        ...
        public static implicit operator MapMarkers(Position location)
		{
