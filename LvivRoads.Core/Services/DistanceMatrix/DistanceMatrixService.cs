...
using LvivRoads.Core.Services.Internal.Http;
...
namespace LvivRoads.Core.Services.DistanceMatrix
{
	...
	public class DistanceMatrixService
	{
		...
		public async Task<DistanceMatrixResponse> GetResponse(DistanceMatrixRequest request)
		{
			var url = new Uri(this.BaseUri, request.ToUri());
			return await Http.Get(url).AsAsync<DistanceMatrixResponse>();
		}
	}
}
