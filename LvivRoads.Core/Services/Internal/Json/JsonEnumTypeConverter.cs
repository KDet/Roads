...
namespace LvivRoads.Core.Services.Internal.Json
{
    public class JsonEnumTypeConverter : JsonConverter
	{
        ...
        public static VehicleType AsVehicleTypeType(string s)
	    {
	        var result = VehicleType.Other;
	        switch (s)
	        {
	            case "RAIL":
	                result = VehicleType.Rail;
	                break;
	            case "METRO_RAIL":
	                result = VehicleType.MetroRail;
	                break;
	            case "SUBWAY":
	                result = VehicleType.Subway;
	                break;
	            case "TRAM":
	                result = VehicleType.Tram;
	                break;
	            case "MONORAIL":
	                result = VehicleType.Monorail;
	                break;
	            case "HEAVY_RAIL":
	                result = VehicleType.HeavyRail;
	                break;
	            case "COMMUTER_TRAIN":
	                result = VehicleType.CommuterTrain;
	                break;
	            case "HIGH_SPEED_TRAIN":
	                result = VehicleType.HighSpeedTrain;
	                break;
	            case "BUS":
	                result = VehicleType.Bus;
	                break;
	            case "INTERCITY_BUS":
	                result = VehicleType.IntercityBus;
	                break;
	            case "TROLLEYBUS":
	                result = VehicleType.Trolleybus;
	                break;
	            case "SHARE_TAXI":
	                result = VehicleType.ShareTaxi;
	                break;
	            case "FERRY":
	                result = VehicleType.Ferry;
	                break;
	            case "CABLE_CAR":
	                result = VehicleType.CableCar;
	                break;
	            case "GONDOLA_LIFT":
	                result = VehicleType.GondolaLift;
	                break;
	            case "FUNICULAR":
	                result = VehicleType.Funicular;
	                break;
	            case "OTHER":
	    ...
	    public override bool CanConvert(Type objectType)
		{
			return
                ...
                || objectType == typeof(VehicleType);
		}

		public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
		{
			if(objectType == typeof(ServiceResponseStatus))
				return AsResponseStatus(reader.Value.ToString());
            if (objectType == typeof(AddressType))
                return AsAddressType(reader.Value.ToString());
            if (objectType == typeof(LocationType))
                return AsLocationType(reader.Value.ToString());
            if (objectType == typeof (VehicleType))
                return AsVehicleTypeType(reader.Value.ToString());
		    return null;
		}
